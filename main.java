...
public class Main {
    public static void main(String[] args) {
        ...
        funcionarios.add(new Funcionario_Comum("Alice", "123.456.789-00", 3000));
        funcionarios.add(new Gerente("Bob", "987.654.321-00", 5000));
        funcionarios.add(new Desenvolvedor("Charlie", "111.222.333-44", 4000, 3));
